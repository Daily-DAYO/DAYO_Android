...
interface FollowApiHelper {
    ...
    suspend fun requestCreateFollow(followerId:String): Response<ResponseCreateFollow>
    ...
    suspend fun requestCreateFollowUp(followerId:String): Response<ResponseCreateFollow>
